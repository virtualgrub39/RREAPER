...
FIRMWARE_SRC += source/main.c 
FIRMWARE_SRC += source/uart.c source/spi.c
FIRMWARE_SRC += source/checksum.c source/ihex.c 
FIRMWARE_SRC += source/eeprom.c source/parallel-port.c 
